...
import {ToolBarType} from "@/hooks/useHighlightEditor.ts";
import { Toolbar } from "@base-ui/react";
import {ArrowTurnLeftIcon, CheckIcon} from "@/components/icons";

const ToolBar = ({toolBar}: { toolBar: ToolBarType }) => (
    <div style={{display: toolBar.toolBarVisibile ? 'block' : 'none'}} className="mb-2">
        <Toolbar.Root
