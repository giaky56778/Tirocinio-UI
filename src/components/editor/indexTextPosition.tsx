    ...
    return (
        <div className={CHAPTER_SELECT_CONTAINER_CLASS}>
            ...
            >
                ...
                <Combobox.Trigger className={CHAPTER_SELECT_TRIGGER_CLASS}>
