...
} from "@/components/editor/highlightEditorWindow.tsx";
import {CHAPTER_SELECT_CONTAINER_CLASS} from "@/components/editor/indexTextPosition.tsx";
    ...
    return(
        <div className={EDITOR_WINDOW_CONTAINER_CLASS}>
            <div className={EDITOR_WINDOW_HEADER_CLASS}>
                <div className="animate-pulse h-10 w-64 rounded-lg bg-blue-200"/>
            </div>
