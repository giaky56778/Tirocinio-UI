                ...
                <Dialog.Popup className="w-xl h-1/2 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col bg-white rounded-lg shadow-xl overflow-hidden">
                    ...
                    <div className="flex items-center justify-between p-4 border-t">
                        ...
                        <Dialog.Close
                            ...
                            className="ml-auto rounded-md bg-orange-700 hover:bg-orange-800 font-bold px-4 py-2 text-sm text-white disabled:opacity-40 cursor-pointer"
                        >
                            Chiudi
                        </Dialog.Close>
                    </div>
